...
require '../models/bancoBGRAreasServiciosM.php';
$camp = new bancoBGRAreasServiciosM();
...
switch ($_GET["action"]) {
    ...
    case 'telefonos':
        $idC = $_GET['idC'];
        $phonesById = ejecutarConsulta2("select contactid from gestionfinalareas where contactid = '$idC'");
    ...
    case 'save':
        if ($IdCliente != "") {
            $saveById = ejecutarConsulta11("select contactid from gestionfinalareas where contactid = '$IdCliente'");
