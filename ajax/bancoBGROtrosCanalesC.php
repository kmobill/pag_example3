...
require '../models/bancoBGROtrosCanalesM.php';
$camp = new bancoBGROtrosCanalesM();
...
switch ($_GET["action"]) {
    ...
    case 'save':
        if ($IdCliente != "") {
            $saveById = ejecutarConsulta11("select contactid from gestionfinalotros where contactid = '$IdCliente'");
