                                    ...
                                    <div id="pnlEncuesta" class="col-xs-12 btn">
                                        <div class="box box-widget bg-gray">
                                            <div class="box-body col-xs-12 btn">
                                                <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta1" name="pregunta1" class="text-bold form-control" value="1.- Mantiene uno o varios ahorros programados con Banco Pichincha?" readonly/></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 2---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta2" name="pregunta2" class="text-bold form-control" value="2.- Porque ahorra?" readonly /></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta2" name="respuesta2" class="form-control">
                                                        ...
                                                        <option>Viaje</option>
                                                        <option>Remodelación de vivienda</option>
                                                        <option>Compra de equipos de computo</option>
                                                        <option>Compra de electrodomésticos</option>
                                                        <option>Compra de implementos para mi negocio</option>
                                                    </select>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 3---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta3" name="pregunta3" class="text-bold form-control" readonly value="3.- ¿Por qué escogió a Banco Pichincha para abrir un ahorro programado?"/></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta3" name="respuesta3" class="form-control">
                                                        <option></option>
                                                        <option>Por su trayectoria</option>
                                                        <option>Por confianza</option>
                                                        <option>Servicio</option>
                                                        <option>Precio</option>
                                                        <option>Producto diferente</option>
                                                        <option>Obligación</option>
                                                        <option>Tasas de interés</option>
                                                    </select>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 4---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta4" name="pregunta4" class="text-bold form-control" value="4.- A cumplido tus expectativas el ahorro programado que tiene?" readonly /></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 5---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta5" name="pregunta5" class="text-bold form-control" value="5.- Qué beneficios a encontrado en el plan de ahorros?" readonly /></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 6---------------------------------------------------->
                                                <div class="col-xs-6"><input id="pregunta6" name="pregunta6" class="text-bold form-control" value="6.- Sabías que al cumplir con el ahorro programado, ganas un bono?" readonly /></div>
                                                <div class="col-xs-6">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 7---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta7" name="pregunta7" class="text-bold form-control" value="7.- ¿Te parece un buen premio el bono?" readonly /></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 8---------------------------------------------------->
                                                <div class="col-xs-6"><input id="pregunta8" name="pregunta8" class="text-bold form-control" readonly value="8.- ¿Te gustaría ganar el bono al inicio del plan programado y no al final?"/></div>
                                                <div class="col-xs-6">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 9---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta9" name="pregunta9" class="text-bold form-control" readonly value="9. Que otros beneficios te gustarían?"/></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta9" name="respuesta9" class="form-control">
                                                        <option></option>
                                                        <option>Bono</option>
                                                        <option>Asistencias</option>
                                                        <option>Tasa de interés más alta</option>
...
<script src="scripts/JS_BPEncuestaBonoAHF.js" type="text/javascript"></script>
