                                    ...
                                    <div id="pnlEncuesta" class="col-xs-12 btn">
                                        <div class="box box-widget bg-gray">
                                            <div class="box-body col-xs-12 btn">
                                                <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta1" name="pregunta1" class="text-bold form-control" value="1.- Coménteme, ¿Cuál fue la razón por la cual no aceptó el ascenso de categoría de su tarjeta de crédito?" readonly/></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta1" name="respuesta1" class="form-control">
                                                        <option></option>
                                                        <option>No requiero el cambio</option>
                                                        <option>Es muy costoso el plan de recompensas</option>
                                                        <option>Requiero un aumento de cupo y no se me ofertó</option>
                                                        <option>Tengo otra entidad que me la opción de no tener el plan de recompensas</option>
                                                        <option>Ya tuve esa tarjeta anteriormente</option>
                                                        <option>No tengo acceso al efectivo express</option>
                                                        <option>Situación económica</option>
                                                    </select>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 2---------------------------------------------------->
                                                <div class="col-xs-6"><input id="pregunta2" name="pregunta2" class="text-bold form-control" value="1.1. ¿Hace cuánto tuvo la tarjeta?" readonly /></div>
                                                <div class="col-xs-6">
                                                    <input id="respuesta2" name="respuesta2" class="form-control" maxlength="500"/>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 3---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta3" name="pregunta3" class="text-bold form-control" readonly value="2.- Si usted pudiese elegir los beneficios de un ascenso de categoría de su tarjeta de crédito ¿Cuál escogería?"/></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta3" name="respuesta3" class="form-control">
                                                        <option></option>
                                                        <option>Aumento de cupo</option>
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 5---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta5" name="pregunta5" class="text-bold form-control" value="3.- ¿Qué tipo de atributos consideraría atractivos para que pueda aceptar un ascenso de categoría de su tarjeta de crédito?" readonly /></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 6---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta6" name="pregunta6" class="text-bold form-control" value="4.- Que productos le gustaría recibir de parte de nosotros?" readonly /></div>
                                                <div class="col-xs-3">
...
<script src="scripts/JS_BPEncuestaNoAceptaConversion.js" type="text/javascript"></script>
