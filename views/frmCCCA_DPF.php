                                    ...
                                    <div id="pnlEncuesta" class="col-xs-12 btn">
                                        <div class="box box-widget bg-gray">
                                            <div class="box-body col-xs-12 btn">
                                                <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                                <div class="col-xs-3"><input id="pregunta1" name="pregunta1" class="text-bold form-control" value="Fecha acercamiento a agencia:" readonly/></div>
                                                <div class="col-xs-3">
                                                    <input type="date" id="respuesta1" name="respuesta1" class="form-control" maxlength="500"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script src="scripts/JS_CCCA_DPF.js" type="text/javascript"></script>
