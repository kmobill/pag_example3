                                    ...
                                    <div id="pnlEncuesta" class="col-xs-12 btn">
                                        <div class="box box-widget bg-gray">
                                            <div class="box-body col-xs-12 btn">
                                                <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta1" name="pregunta1" class="text-bold form-control" value="1. ¿Qué tanta dificultad tuvo con la adquisición de su cuenta para recibir su sueldo en Banco Pichincha? " readonly/></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 3---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta3" name="pregunta3" class="text-bold form-control" value="2. ¿Recuerda la interacción que tuvo con el ejecutivo de Banco Pichincha cuando visitó su empresa y le ayudó con el papeleo de la cuenta?" readonly/></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 4---------------------------------------------------->
                                                <div class="col-xs-9"><textarea rows="3" id="pregunta4" name="pregunta4" class="text-bold form-control" readonly>2.1. En la escala de 1 a 10 donde, donde “1 es Muy Insatisfecho y 10 Muy Satisfecho”, por favor califique: ¿Cuál fue su grado de satisfacción con la asesoría brindada por el ejecutivo de Banco Pichincha cuando le ayudó con los papeleos y le entregó la tarjeta de débito (si es que aplica)?</textarea></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 5---------------------------------------------------->
                                                <div class="col-xs-8"><input id="pregunta5" name="pregunta5" class="text-bold form-control" value="2.2. Brevemente cuenteme por favor, ¿por qué motivos eligió esa calificación?" readonly /></div>
                                                <div class="col-xs-4">
                                                    <input id="respuesta5" name="respuesta5" class="form-control" maxlength="500"/>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 6---------------------------------------------------->
                                                <div class="col-xs-9"><textarea rows="3" id="pregunta6" name="pregunta6" class="text-bold form-control" readonly>3 . En la escala de 1 a 10 donde, donde “1 es Muy Insatisfecho y 10 Muy Satisfecho”, por favor califique: ¿Cuál fue su grado de satisfacción general con el proceso de adquisición de cuenta y tarjeta de débito para recibir su sueldo con Banco Pichincha?</textarea></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 7---------------------------------------------------->
                                                <div class="col-xs-8"><input id="pregunta7" name="pregunta7" class="text-bold form-control" value="3.1. Brevemente dígame, ¿por qué motivos eligió esa calificación?" readonly /></div>
                                                <div class="col-xs-4">
                                                    <input id="respuesta7" name="respuesta7" class="form-control" maxlength="500"/>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 8---------------------------------------------------->
                                                <div class="col-xs-9"><textarea rows="3" id="pregunta8" name="pregunta8" class="text-bold form-control" readonly>4. En una escala de 0 a 10, donde 0 es “Nada dispuesto(a)” y 10 “Totalmente dispuesto(a)” ¿qué tan dispuesto(a) estaría a recomendar Banco Pichincha a un colega, amigo o familiar en base a la experiencia que tuvo adquiriendo su cuenta y tarjeta de débito para recibir su sueldo?</textarea></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 9---------------------------------------------------->
                                                <div class="col-xs-8"><input id="pregunta9" name="pregunta9" class="text-bold form-control" value="" readonly /></div>
                                                <div class="col-xs-4">
...
<script src="scripts/JS_BPEncuestaNomina.js" type="text/javascript"></script>
