                                    ...
                                    <div id="pnlEncuesta" class="col-xs-12 btn">
                                        <div class="box box-widget bg-gray">
                                            <div class="box-body col-xs-12 btn">
                                                <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta1" name="pregunta1" class="text-bold form-control" value="1. ¿Conoce usted el programa de recompensas y uso de millas de la tarjeta Latampass Banco Pichincha?" readonly/></div>
                                                <div class="col-xs-3">
                                                ...
                                                <div class="col-xs-3">
                                                    <select id="respuesta2" name="respuesta2" class="form-control">
                                                        ...
                                                        <option>Poco Frecuente</option>
                                                        <option>Nunca/No uso</option>
                                                    </select> 
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 3---------------------------------------------------->
        <!--                                        <div class="col-xs-6"><input id="pregunta3" name="pregunta3" class="text-bold form-control" readonly value="2. Cuál es el motivo porque no utiliza su tarjeta?"/></div>
                                                <div class="col-xs-6">
                                                    <input id="respuesta3" name="respuesta3" class="form-control" maxlength="500"/>
                                                </div>-->
                                                <!---------------------------------------------------------PREGUNTA 4---------------------------------------------------->
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 5---------------------------------------------------->
                                                <div class="col-xs-6"><input id="pregunta5" name="pregunta5" class="text-bold form-control" readonly /></div>
                                                <div class="col-xs-6">
                                                    <input id="respuesta5" name="respuesta5" class="form-control" maxlength="500"/>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 6---------------------------------------------------->
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 7---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta7" name="pregunta7" class="text-bold form-control" value="5. Ahora cuénteme ¿Conoce usted el programa de recompensas de la tarjeta Pichincha Miles?" readonly /></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 8---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta8" name="pregunta8" class="text-bold form-control" readonly value="6. ¿Con que frecuencia usted accede a los beneficios del programa de recompensas de la tarjeta Pichincha Miles?"/></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 9---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta9" name="pregunta9" class="text-bold form-control" readonly value="12.	¿Tiene usted la tarjeta Pichincha Miles?"/></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 10---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta10" name="pregunta10" class="text-bold form-control" value="7.	¿Del 0 al 10 que tanto recomienda usted a sus amigos o familiares el programa de recompensas de la tarjeta Pichincha Miles? Siendo 0 No lo recomienda y 10, si lo recomienda" readonly /></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 11---------------------------------------------------->
                                                <div class="col-xs-6"><input id="pregunta11" name="pregunta11" class="text-bold form-control" value="7.1. ¿Cuál fue el motivo principal para darnos esa calificación?" readonly /></div>
                                                <div class="col-xs-6">
                                                    <input id="respuesta11" name="respuesta11" class="form-control" maxlength="500"/>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 12---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta12" name="pregunta12" class="text-bold form-control" value="8.	Si su experiencia con el programa de recompensas de la tarjeta Pichincha Miles se mantiene igual a la que ha tenido hasta ahora, ¿por cuánto tiempo más consideraría seguir usándola?" readonly /></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 13---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta13" name="pregunta13" class="text-bold form-control" value="13. ¿Del 0 al 10 que tanto recomienda usted a sus amigos o familiares el uso de la tarjeta Pichincha Miles? Siendo 0 No lo recomienda y 10, si lo recomienda" readonly /></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 14---------------------------------------------------->
                                                <div class="col-xs-6"><input id="pregunta14" name="pregunta14" class="text-bold form-control" value="13.1 ¿Cuál fue el motivo principal para darnos esa calificación?" readonly /></div>
                                                <div class="col-xs-6">
                                                    <input id="respuesta14" name="respuesta14" class="form-control" maxlength="500"/>
                                                </div>

                                                <div class="col-xs-9"><input id="pregunta15" name="pregunta15" class="text-bold form-control" value="14. Si su experiencia con la tarjeta Pichincha Miles se mantiene igual a la que ha tenido hasta ahora, ¿por cuánto tiempo más consideraría seguir usándola?" readonly /></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 15---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta16" name="pregunta16" class="text-bold form-control" value="12.1 ¿Ha recibido ofertas para adquirir la tarjeta de Pichincha Miles?" readonly /></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 16---------------------------------------------------->
                                                <div class="col-xs-6"><input id="pregunta17" name="pregunta17" class="text-bold form-control" readonly value="12.1.1 ¿Por qué razones no ha aceptado la tarjeta Pichincha Miles?"/></div>
                                                <div class="col-xs-6">
                                                    <input id="respuesta17" name="respuesta17" class="form-control" maxlength="500"/>
                                                </div>
...
<script src="scripts/JS_BPEncuestaLatam3.js" type="text/javascript"></script>
