...
$('#respuesta1').change(function () {
    if ($('#respuesta1').val() == 'Pago Total') {
        ...
        $('#respuesta6').attr('readonly', true);
        $('#respuesta6').attr('required', false);
    } else if ($('#respuesta1').val() == 'Se acercará a la agencia'){
        $('#respuesta2').val("");
        $('#respuesta3').val("");
        $('#respuesta5').val("");
        $('#respuesta2').attr('readonly', true);
...
$('#respuesta6').change(function () {
    if ($('#respuesta6').val() == 'AGENCIA MATRIZ') {
        $('#respuesta7').val("LUNES A VIERNES: 08:00am-17:00 pm; SABADOS: Cerrado; DOMINGOS: Cerrado");
    } else if ($('#respuesta6').val() == 'AGENCIA GUALACEO') {
        $('#respuesta7').val("LUNES A VIERNES: 08:00am-16:40 pm; SABADOS: Cerrado; DOMINGOS: 09:00am-13:00pm");
    } else if ($('#respuesta6').val() == 'VENTANILLA GUARAINAG') {
        $('#respuesta7').val("LUNES A VIERNES: Cerrado; SABADOS: Cerrado; DOMINGOS: 09:00am-13:00pm");
    } else if ($('#respuesta6').val() == 'VENTANILLA SAN JUAN') {
        $('#respuesta7').val("LUNES A VIERNES: Cerrado; SABADOS: Cerrado; DOMINGOS: 09:00am-13:00pm");
    } else {
        $('#respuesta7').val("");
    }
