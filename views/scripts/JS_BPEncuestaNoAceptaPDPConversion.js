...
$('#respuesta1').change(function () {
    if ($('#respuesta1').val() == 'Ya tengo otro seguro') {
        $('#pregunta2').show();
        $('#respuesta2').show();
        $('#pregunta3').show();
        $('#respuesta3').show();
...
$('#respuesta4').change(function () {
    if ($('#respuesta4').val() == 'Coberturas más amplias') {
        $('#pregunta5').show();
        $('#pregunta5').val("2.1.- ¿Qué tipo de coberturas?");
        $('#respuesta5').show();
    } else if ($('#respuesta4').val() == 'Descuentos') {
        $('#pregunta5').show();
        $('#pregunta5').val("2.1.- ¿Qué tipo de descuentos?");
        $('#respuesta5').show();
    } else {
        $('#pregunta5').hide();
        $('#respuesta5').hide();
...
$('#respuesta6').change(function () {
    if ($('#respuesta6').val() == 'Coberturas especificas') {
        $('#pregunta7').show();
        $('#respuesta7').show();
    } else {
        $('#pregunta7').hide();
