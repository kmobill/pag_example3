...
function mostrar_todos() {
    tabla = $('#tblListado').dataTable({
        ...
        "ajax": {
            url: '../ajax/bpEncuestaGenerica.php?action=selectAll_9',
            type: "get",
            dataType: "json",
            error: function (e) {
...
$('#respuesta1').change(function () {
    if ($('#respuesta1').val() == 'Recibo muchas ofertas por parte de Banco') {
        $('#pregunta2').show();
        $('#respuesta2').show();
    } else {
        $('#pregunta2').hide();
