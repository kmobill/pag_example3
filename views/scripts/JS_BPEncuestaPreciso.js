...
function mostrar_todos() {
    tabla = $('#tblListado').dataTable({
        ...
        "ajax": {
            url: '../ajax/bpEncuestaGenerica.php?action=selectAll_12',
            type: "get",
            dataType: "json",
            error: function (e) {
...
$('#respuesta5').change(function () {
    if ($('#respuesta5').val() == '0' || $('#respuesta5').val() == '1' || $('#respuesta5').val() == '2' || $('#respuesta5').val() == '3' || $('#respuesta5').val() == '4'
            || $('#respuesta5').val() == '5' || $('#respuesta5').val() == '6') {
        $('#pregunta6').show();
        $('#respuesta6').show();
        $('#pregunta6').val("3.1 ¿Qué podríamos hacer de manera diferente para que nos recomiende?");
    } else if ($('#respuesta5').val() == '7' || $('#respuesta5').val() == '8') {
        $('#pregunta6').show();
        $('#respuesta6').show();
        $('#pregunta6').val("3.2 ¿Qué podríamos hacer diferente o mejor para tener una calificación más alta?");
    } else if ($('#respuesta5').val() == '9' || $('#respuesta5').val() == '10') {
        $('#pregunta6').show();
        $('#respuesta6').show();
        $('#pregunta6').val("3.3 ¿Qué aspectos de su experiencia adquiriendo Préstamo de Consumo con Banco Pichincha destaca cuando nos recomienda?");
    } else {
        $('#pregunta6').hide();
        $('#respuesta6').hide();
        $('#respuesta6').val("");
