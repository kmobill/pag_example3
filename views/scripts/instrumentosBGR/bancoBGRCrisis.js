...
function init() { /* función inicial */
    ...
    pnlEncuesta1(false, true);
    pnlEncuesta2(false, true);
    $('#pnlEncuesta1').hide();
    $('#pnlEncuesta2').hide();
}
...
$('#respuesta2').change(function () {
    if ($('#respuesta2').val() == 'Si') {
        $('#pnlEncuesta1').show();
        $('#pnlEncuesta2').hide();
        pnlEncuesta1(true, false);
        pnlEncuesta2(false, true);

    } else if ($('#respuesta2').val() == 'No') {
        $('#pnlEncuesta1').hide();
        $('#pnlEncuesta2').show();
        pnlEncuesta1(false, true);
        pnlEncuesta2(true, false);
    } else {
        $('#pnlEncuesta1').hide();
        $('#pnlEncuesta2').hide();
        pnlEncuesta1(false, true);
...
function pnlEncuesta1(state1, state2) {
    ...
    $('#respuesta11').attr('required', state1);
    $('#respuesta11').attr('readonly', state2);
}

function pnlEncuesta2(state1, state2) {
