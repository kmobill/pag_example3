...
function mostrar_todos() {
    tabla = $('#tblListado').dataTable({
        ...
        "ajax": {
            url: '../ajax/bpEncuestaGenerica.php?action=selectAll_14',
            type: "get",
            dataType: "json",
            error: function (e) {
...
$('#respuesta5').change(function () {
    if ($('#respuesta5').val() == '1' || $('#respuesta5').val() == '2' || $('#respuesta5').val() == '3' || $('#respuesta5').val() == '4'
        ...
        $('#pregunta6').show();
        $('#respuesta6').show();
        $('#pregunta6').val("3.3 ¿Qué aspectos de su experiencia adquiriendo el crédito hipotecario con Banco Pichincha destaca cuando nos recomienda?");
    } else {
        $('#pregunta6').hide();
        $('#respuesta6').hide();
        $('#respuesta6').val("");
