...
$('#respuesta5').change(function () {
    if ($('#respuesta5').val() == 'MUY FACIL' || $('#respuesta5').val() == 'FACIL') {
        $('#pregunta6').val("Qué lo hizo Muy fácil/ fácil?");
        $('#pregunta6').show();
        $('#respuesta6').show();
        $('#respuesta6').attr('readonly', false);
        $('#respuesta6').attr('required', true);
    } else if ($('#respuesta5').val() == 'POCO FACIL' || $('#respuesta5').val() == 'DIFICIL' || $('#respuesta5').val() == 'MUY DIFICIL') {
        $('#pregunta6').val("Cuál es el motivo de su calificación?");
        $('#pregunta6').show();
        $('#respuesta6').show();
        $('#respuesta6').attr('readonly', false);
        $('#respuesta6').attr('required', true);
...
$('#respuesta7').change(function () {
    if ($('#respuesta7').val() == '0' || $('#respuesta7').val() == '1' || $('#respuesta7').val() == '2' || $('#respuesta7').val() == '3' ||
            $('#respuesta7').val() == '4' || $('#respuesta7').val() == '5' || $('#respuesta7').val() == '6') {
        $('#pregunta8').val("Cuál es el motivo de su calificación?");
        $('#pregunta8').show();
        $('#respuesta8').show();
        $('#respuesta8').attr('readonly', false);
        $('#respuesta8').attr('required', true);
    } else if ($('#respuesta7').val() == '7' || $('#respuesta7').val() == '8') {
        $('#pregunta8').val("Qué podriamos mejorar?");
        $('#pregunta8').show();
        $('#respuesta8').show();
        $('#respuesta8').attr('readonly', false);
        $('#respuesta8').attr('required', true);
    } else if ($('#respuesta7').val() == '9' || $('#respuesta7').val() == '10') {
        $('#pregunta8').val("Qué fue lo que mas le gustó para recomendarnos?");
        $('#pregunta8').show();
        $('#respuesta8').show();
        $('#respuesta8').attr('readonly', false);
        $('#respuesta8').attr('required', true);
