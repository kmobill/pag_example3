...
function limpiar_formulario() {
    $("#titulo").text("Cooperativa Mushuc Runa - Créditos");
    $("#titulo1").text("");
    $("#titulo2").text("");
    $('#FECHA_AGENDA_CRD').attr('required', false);
    $('#FECHA_AGENDA_CRD').attr('readonly', true);
    $('#HORA_AGENDA_CRD').attr('required', false);
    $('#HORA_AGENDA_CRD').attr('readonly', true);
    $('#FECHA_AGENDA_CRD').val("");
    $('#HORA_AGENDA_CRD').val("");
}
...
function mostrar_uno(Id) {
    $.post("../ajax/cccaCreditosC.php?action=selectById", {Id: Id}, function (datos, estado) {
        ...
        $('#MONTO_MAXIMO').val(datos.MONTO_MAXIMO_CRD);
        $('#PLAZO_CREDITO').val(datos.PLAZO_CRD);
        $('#TIPO_CREDITO').val(datos.TIPO_CRD);
        ...
        $('#ESTADO_SOCIO').val(datos.ESTADO_SOCIO);
        ...
        $('#NOMBRE_COOPERATIVA').val(datos.NOMBRE_COOPERATIVA);
    ...
    if (level1 !== "" && level2 !== "") {
        id = $.ajax({
            ...
            success: function (r) {
                $('#code').val(r);
                if (r == 1) {
                    $('#FECHA_AGENDA_CRD').attr('required', true);
                    $('#FECHA_AGENDA_CRD').attr('readonly', false);
                    $('#HORA_AGENDA_CRD').attr('required', true);
                    $('#HORA_AGENDA_CRD').attr('readonly', false);
                } else {
                    limpiar_formulario();
                }
            }
