...
$('#respuesta1').change(function () {
    if ($('#respuesta1').val() == 'Independiente' || $('#respuesta1').val() == 'Tengo 2 actividades económicas: independiente + dependiente') {
        $('#txtEnunciado').hide();
        $('#pregunta2').show();
        $('#respuesta2').show();
        $('#pregunta3').show();
...
$('#respuesta6').change(function () {
    if ($('#respuesta6').val() == 'No') {
        $('#pregunta7').show();
        $('#respuesta7').show();
		$('#respuesta7').val("¿En cuánto tiempo puede conseguirlo?");
        $('#respuesta7').attr('required', true);
        $('#respuesta7').attr('readonly', false);
    } else {
        $('#pregunta7').show();
        $('#respuesta7').show();
		$('#respuesta7').val("¿En cuánto tiempo puede entregarlo?");
        $('#respuesta7').attr('required', true);
        $('#respuesta7').attr('readonly', false);
    }
});
...
$('#respuesta8').change(function () {
    if ($('#respuesta8').val() == 'No') {
        $('#pregunta9').show();
        $('#respuesta9').show();
		$('#respuesta9').val("¿En cuánto tiempo puede conseguirlo?");
        $('#respuesta9').attr('required', true);
        $('#respuesta9').attr('readonly', false);
    } else {
        $('#pregunta9').show();
        $('#respuesta9').show();
		$('#respuesta9').val("¿En cuánto tiempo puede entregarlo?");
        $('#respuesta9').attr('required', true);
        $('#respuesta9').attr('readonly', false);
    }
});
...
$('#respuesta10').change(function () {
    if ($('#respuesta10').val() == 'No') {
        $('#pregunta11').show();
        $('#respuesta11').show();
		$('#respuesta11').val("¿En cuánto tiempo puede conseguirlo?");
        $('#respuesta11').attr('required', true);
        $('#respuesta11').attr('readonly', false);
    } else {
        $('#pregunta11').show();
        $('#respuesta11').show();
		$('#respuesta11').val("¿En cuánto tiempo puede entregarlo?");
        $('#respuesta11').attr('required', true);
        $('#respuesta11').attr('readonly', false);
    }
});
...
$('#respuesta12').change(function () {
    if ($('#respuesta12').val() == 'No') {
        $('#pregunta13').show();
        $('#respuesta13').show();
		$('#respuesta13').val("¿En cuánto tiempo puede conseguirlo?");
        $('#respuesta13').attr('required', true);
        $('#respuesta13').attr('readonly', false);
    } else {
        $('#pregunta13').show();
        $('#respuesta13').show();
		$('#respuesta13').val("¿En cuánto tiempo puede entregarlo?");
        $('#respuesta13').attr('required', true);
        $('#respuesta13').attr('readonly', false);
    }
});
...
$('#respuesta14').change(function () {
    if ($('#respuesta14').val() == 'No') {
        $('#pregunta15').show();
        $('#respuesta15').show();
		$('#respuesta15').val("¿En cuánto tiempo puede conseguirlo?");
        $('#respuesta15').attr('required', true);
        $('#respuesta15').attr('readonly', false);
    } else {
        $('#pregunta15').show();
        $('#respuesta15').show();
		$('#respuesta15').val("¿En cuánto tiempo puede entregarlo?");
        $('#respuesta15').attr('required', true);
        $('#respuesta15').attr('readonly', false);
    }
});
...
$('#respuesta16').change(function () {
    if ($('#respuesta16').val() == 'No') {
        $('#pregunta17').show();
        $('#respuesta17').show();
		$('#respuesta17').val("¿En cuánto tiempo puede conseguirlo?");
        $('#respuesta17').attr('required', true);
        $('#respuesta17').attr('readonly', false);
    } else {
        $('#pregunta17').show();
        $('#respuesta17').show();
		$('#respuesta17').val("¿En cuánto tiempo puede entregarlo?");
        $('#respuesta17').attr('required', true);
        $('#respuesta17').attr('readonly', false);
    }
});
...
function pnlEncuesta(state1, state2) {
    ...
    $('#respuesta8').attr('required', state1);
    $('#respuesta10').attr('required', state1);
    ...
    $('#respuesta20').attr('required', state1);
    ...
    $('#respuesta20').attr('readonly', state2);
}