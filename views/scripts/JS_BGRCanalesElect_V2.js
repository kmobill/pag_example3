...
function mostrar_uno(Id) {
    ...
    $.post("../ajax/bancoBGRCanalesElectronicosC.php?action=selectById", {Id: Id}, function (datos, estado) {
        ...
        if (datos.SEGMENTO == 'CALL CENTER') {
            $('#pregunta13').val("Califique del 1 al 10 siendo 1 poco satisfecho y 10 muy satisfecho: Su grado de satisfacción con el servicio recibido en el Call Center");
            $('#pregunta14').val("¿Que tan fácil es para usted gestionar su requerimiento de Call Center?");
            $('#lbl').show();
            $('#pregunta18').show();
            $('#respuesta18').show();
        } else if (datos.SEGMENTO == 'BGR NET APP') {
            $('#pregunta13').val("Califique del 1 al 10 siendo 1 poco satisfecho y 10 muy satisfecho: Su grado de satisfacción con el servicio recibido en BGR Net App");
            ...
            $('#pregunta13').val("Califique del 1 al 10 siendo 1 poco satisfecho y 10 muy satisfecho: Su grado de satisfacción con el servicio recibido en BGR Net Web");
...
$('#respuesta18').change(function () {
    if ($('#respuesta18').val() == 'No') {
        $('#pregunta18_1').show();
        $('#respuesta18_1').show();
        $('#respuesta18_1').attr('readonly', false);
        $('#respuesta18_1').attr('required', true);
    } else {
        $('#pregunta18_1').hide();
        $('#respuesta18_1').hide();
        $('#respuesta18_1').val("");
        $('#respuesta18_1').attr('readonly', true);
        $('#respuesta18_1').attr('required', false);
    }
});
