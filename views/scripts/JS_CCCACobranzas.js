...
function limpiar_formulario() {
    $("#titulo").text("Campaña Gualaquiza");
    $("#titulo1").text("");
    $("#titulo2").text("");
...
$('#respuesta1').change(function () {
    if ($('#respuesta1').val() == 'Pago Parcial' || $('#respuesta1').val() == 'Pago Total') {
...
$('#respuesta4').change(function () {
    if ($('#respuesta4').val() == 'Se acercará a la agencia') {
...
$('#respuesta6').change(function () {
    if ($('#respuesta6').val() == 'AMBATO MATRIZ' || $('#respuesta6').val() == 'VENTANILLA FICOA AMBATO') {
        $('#respuesta7').val("LUNES A VIERNES: 7:30 am-19:00 pm; SABADOS: 8:00 am-13:00 pm; DOMINGOS: Cerrado");
    } else if ($('#respuesta6').val() == 'CENTRO FINANCIERO') {
        $('#respuesta7').val("LUNES A VIERNES: 7:30 am-19:00 pm; SABADOS: 9:00 am-13:00 pm pm; DOMINGOS: 9:00 am-13:00 pm");
    } else if ($('#respuesta6').val() == 'BAÑOS') {
        $('#respuesta7').val("LUNES A VIERNES: 8:00 am-16:30 pm; SABADOS: Cerrado; DOMINGOS: 8:00 am-13:00 pm");
    } else if ($('#respuesta6').val() == 'PELILEO') {
        $('#respuesta7').val("LUNES A VIERNES: 8:00 am-16:30 pm; SABADOS: 8:00 am-13:00 pm; DOMINGOS: Cerrado");
    } else if ($('#respuesta6').val() == 'PILLARO') {
        $('#respuesta7').val("LUNES A VIERNES: 8:00 am-16:30 pm; SABADOS: Cerrado; DOMINGOS: 8:00 am-13:00 pm");
    } else if ($('#respuesta6').val() == 'QUITO-VALLE DE LOS CHILLOS') {
        $('#respuesta7').val("LUNES A VIERNES: 8:00 am-16:30 pm; SABADOS: Cerrado; DOMINGOS: Cerrado");
    } else if ($('#respuesta6').val() == 'GUARANDA' || $('#respuesta6').val() == 'PUYO') {
        $('#respuesta7').val("LUNES A VIERNES: 8:00 am-17:00 pm; SABADOS: 8:00 am-13:00 pm; DOMINGOS: Cerrado");
    } else if ($('#respuesta6').val() == 'GUAYAQUIL' || $('#respuesta6').val() == 'QUITO NORTE') {
        $('#respuesta7').val("LUNES A VIERNES: 8:30 am-17:00 pm; SABADOS: 8:30 am-13:30 pm; DOMINGOS: Cerrado");
    } else if ($('#respuesta6').val() == 'LATACUNGA') {
        $('#respuesta7').val("LUNES A VIERNES: 9:00 am-17:30 pm; SABADOS: 9:00 am-13:00 pm; DOMINGOS: Cerrado");
    } else {
        $('#respuesta7').val("");
    }
});
