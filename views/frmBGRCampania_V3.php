            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="text-bold">Campaña BGR Encuestas</h4>
                    </div>
                    ...
                    <div class="panel-body" id="formularioRegistros">
                        <form name="formulario" id="formulario" method="POST" class="">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12">
                                <div class="box box-widget">
                                    ...
                                    <div class="btn bg-gray-light">
                                        <div class="col-xs-3 hidden">
                                            ...
                                            <input type="text" class="form-control input-sm" id="estadoAuditoria" name="estadoAuditoria" value="AUDITADO" readonly/>
                                        </div>
                                ...
                                <!--Panel de levantamiento de información-->
                                <div id="pnlEncuesta" class="col-xs-12 btn">
                                    <div class="box box-widget bg-gray">
                                        <div class="box-body">
                                            ...
                                            <div class="col-xs-10"><input id="pregunta9" name="pregunta9" class="text-bold form-control" value="Califique del 1 al 10 siendo 1 poco satisfecho y 10 muy satisfecho: Su grado de satisfacción con el servicio recibido en la agencia" readonly/></div>
                                            <div class="col-xs-2">
...
<script src="scripts/JS_BGREncuestas_V4.js" type="text/javascript"></script>
