                                    ...
                                    <div id="pnlEncuesta" class="col-xs-12 btn">
                                        <div class="box box-widget bg-gray">
                                            <div class="box-body col-xs-12 btn">
                                                <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta1" name="pregunta1" class="text-bold form-control" value="1. ¿Coménteme cuál fue la razón por la que dirigió su requerimiento a una cuenta de correo de Banco Pichincha?" readonly/></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta1" name="respuesta1" class="form-control">
                                                        <option></option>
                                                        <option>Por facilidad en el contacto</option>
                                                        <option>Por costo de la llamada</option>
                                                        <option>No me gusta la atención vía telefónica</option>
                                                        <option>Desconozco de otro canal de atención</option>
                                                        <option>Me indicaron que escriba a este correo</option>
                                                    </select>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 2---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta2" name="pregunta2" class="text-bold form-control" value="2. ¿Si tuviese que elegir un canal de atención en Banco Pichincha, cual elegiría?" readonly /></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta2" name="respuesta2" class="form-control">
                                                        <option></option>
                                                        <option>Atención presencial / Agencia</option>
                                                        <option>Cuentas de Correo Electrónico</option>
                                                        <option>Llamada Telefónica - IVR</option>
                                                        <option>WhatsApp</option>
                                                        <option>On-line a través de video conferencia</option>
                                                        <option>Redes Sociales</option>
                                                    </select> 
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 3---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta3" name="pregunta3" class="text-bold form-control" readonly value="3. ¿Coménteme cuál fue el medio por el que conoció acerca de este canal de atención?"/></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta3" name="respuesta3" class="form-control">
                                                        <option></option>
                                                        <option>Direccionamiento de otro canal</option>
                                                        <option>Redes Sociales</option>
                                                        <option>Página web</option>
                                                        <option>Amigo / familiar</option>
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 4---------------------------------------------------->
                                                <div class="col-xs-12"><input id="pregunta4" name="pregunta4" class="text-bold form-control" value="4. De acuerdo a su experiencia ¿Coménteme cuál sería el tiempo ideal para dar respuesta a su requerimiento mediante este canal?" readonly /></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta4" name="respuesta4" class="form-control">
                                                        <option></option>
                                                        <option>De 0 a 1 hora</option>
                                                        <option>De 1 a 2 horas</option>
                                                        <option>De 2 a 3 horas</option>
...
<script src="scripts/JS_BPEncuestaVOCBuzones.js" type="text/javascript"></script>
