...
<div class="content-wrapper">
    <section class="content">
        <h1 class="text-blue ">Envío de correos masivos</h1>
        <form class="container-fluid" id="frmcargararchivo" name="frmcargararchivo" method="post" enctype="multipart/form-data">
            ...
            <div class="row1 col-xs-3 text-left">
...
<script src="scripts/correosMasivosGenericos.js" type="text/javascript"></script>