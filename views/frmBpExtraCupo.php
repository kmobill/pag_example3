                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12">
                                <div class="box box-widget">
                                    ...
                                    <div class="col-xs-12 btn bg-gray-light">
                                        ...
                                        <div class="col-xs-2"> <b>CUPO ACTUALIZADO </b>
                                    ...
                                    <div id="pnlEncuesta" class="col-xs-12 btn">
                                        <div class="box box-widget bg-gray">
                                            <div class="box-body">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 2---------------------------------------------------->
                                                <div class="col-xs-6"><input id="pregunta2" name="pregunta2" class="text-bold form-control" value="2. ¿Por favor me puede confirmar en qué establecimiento haría uso de este beneficio?" readonly/></div>
                                                <div class="col-xs-6">
...
<script src="scripts/JS_BPExtraCupo.js" type="text/javascript"></script>
