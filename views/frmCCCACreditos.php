            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="text-bold">Cooperativa de Cámara de Comercio de Ambato - Créditos</h4> </div>
                                    ...
                                    <div id="pnlEncuesta" class="col-xs-12 btn">
                                        <div class="box box-widget bg-gray">
                                            <div class="box-body col-xs-12 btn">
                                                <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                                <div class="col-xs-9"><input class="text-bold form-control" value="Monto aceptado por el cliente" readonly/></div>
                                                <div class="col-xs-3">
                                                    <input type="number" pattern="^[0-9]+" id="MONTO_ACEPTADO_CRD" name="MONTO_ACEPTADO_CRD" class="text-bold form-control" readonly/>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 2---------------------------------------------------->
                                                <div class="col-xs-9"><input class="text-bold form-control" readonly value="Plazo aceptado por el cliente"/></div>
                                                <div class="col-xs-3">
                                                    <input type="number" pattern="^[0-9]+" id="PLAZO_ACEPTADO_CRD" name="PLAZO_ACEPTADO_CRD" class="text-bold form-control" readonly/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script src="scripts/JS_CoopCCACreditos.js" type="text/javascript"></script>
