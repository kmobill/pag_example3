                                    ...
                                    <div id="pnlEncuesta" class="col-xs-12 btn">
                                        <div class="box box-widget bg-gray">
                                            <div class="box-body col-xs-12 btn">
                                                <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta1" name="pregunta1" class="text-bold form-control" value="1. ¿Qué tanta dificultad tuviste para adquirir el crédito hipotecario Banco Pichincha?" readonly/></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 3---------------------------------------------------->
                                                <div class="col-xs-9"><textarea rows="3" id="pregunta3" name="pregunta3" class="text-bold form-control" readonly>2. Cuénteme, en una escala de 1 a 10 donde, donde “1 es Muy Insatisfecho y 10 Muy Satisfecho”, ¿cuál fue su grado de satisfacción general con el proceso de adquisición del crédito hipotecario de Banco Pichincha?</textarea></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 5---------------------------------------------------->
                                                <div class="col-xs-9"><textarea rows="3" id="pregunta5" name="pregunta5" class="text-bold form-control" readonly>3. En una escala de 0 a 10, donde 0 es NADA DISPUEST@ y 10 TOTALMENTE DISPUEST@, ¿qué tan dispuest@ estaría a recomendar Banco pichincha a un colega, amigo o familiar en base a la experiencia que tuvo adquiriendo el crédito hipotecario?</textarea></div>
                                                <div class="col-xs-3">
...
<script src="scripts/JS_BPEncuestaHipotecaria.js" type="text/javascript"></script>
