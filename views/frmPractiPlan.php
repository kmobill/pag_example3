                            ...
                            <div id="pnlEncuesta" class="col-xs-12 btn">
                                <div class="box box-widget bg-gray">
                                    <div class="box-body col-xs-12 btn">
                                        <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                        <div class="col-xs-9"><input class="text-bold form-control" value="Número celular para Whatsapp" readonly/></div>
                                        <div class="col-xs-3">
                                            <input type="number" pattern="^09(\d{8})$" id="respuesta1" name="respuesta1" class="text-bold form-control" readonly/>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script src="scripts/JS_PractiPlan.js" type="text/javascript"></script>
