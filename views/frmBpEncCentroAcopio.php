                                    ...
                                    <div id="pnlEncuesta" class="col-xs-12 btn">
                                        <div class="box box-widget bg-gray">
                                            <div class="box-body col-xs-12 btn">
                                                <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta1" name="pregunta1" class="text-bold form-control" value="1. ¿Qué empresa transportadora de valores utiliza para el envío o la recepción del dinero?" readonly/></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta1" name="respuesta1" class="form-control">
                                                        <option></option>
                                                        <option>VASERUM</option>
                                                        <option>FORTIUS</option>
                                                    </select>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 2---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta2" name="pregunta2" class="text-bold form-control" value="2. ¿Cómo calificaría la atención del personal de la transportadora (VASERUM O FORTIUS)?" readonly /></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 3---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta3" name="pregunta3" class="text-bold form-control" readonly value="3. ¿Cómo calificaría la atención a sus requerimientos (envíos y retiros de efectivo) por parte de Gestión del Efectivo y Valorados?"/></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 4---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta4" name="pregunta4" class="text-bold form-control" value="4. ¿Cómo calificaría la atención a sus reclamos por parte de Gestión del Efectivo y Valorados?" readonly /></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 5---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta5" name="pregunta5" class="text-bold form-control" value="5. ¿Cómo calificaría la atención del personal de Gestión del Efectivo y Valorados? " readonly /></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 6---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta6" name="pregunta6" class="text-bold form-control" value="6. ¿Cómo calificaría la comunicación de novedades en los depósitos realizados al Banco Central del Ecuador por parte de Gestión del efectivo y Valorados?" readonly /></div>
                                                <div class="col-xs-3">
...
<script src="scripts/JS_BPEncuestaCentroAcopio.js" type="text/javascript"></script>
