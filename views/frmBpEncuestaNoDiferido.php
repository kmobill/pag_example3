                                    ...
                                    <div id="pnlEncuesta" class="col-xs-12 btn">
                                        <div class="box box-widget bg-gray">
                                            <div class="box-body col-xs-12 btn">
                                                <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta1" name="pregunta1" class="text-bold form-control" value="1. ¿Cuál fue la razón porque no aceptó el diferido especial?" readonly/></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta1" name="respuesta1" class="form-control">
                                                        ...
                                                        <option>Tengo diferidos en otras instituciones</option>
                                                        <option>Prefiero ir a la agencia</option>
                                                        <option>Ya tomé una oferta de diferido hace pocos meses</option>
                                                        <option>Tengo diferidos vigente con Banco Pichincha</option>
                                                        <option>Desconfío de las llamadas para hacer transacciones</option>
                                                        <option>Necesito documentos</option>
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 3---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta3" name="pregunta3" class="text-bold form-control" readonly value="2. Si usted pudiese elegir los beneficios de un diferido especial ¿Cuál escogería?"/></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta3" name="respuesta3" class="form-control">
                                                        <option></option>
                                                        <option>Tasa de interés más baja</option>
                                                        <option>Tasas de interés acorde al resto de bancos o cooperativas</option>
                                                        <option>Plazos más extensos</option>
                                                        <option>Millas o kilómetros</option>
                                                        <option>Premios o descuentos</option>
                                                        <option>Beneficios adicionales</option>
                                                        <option>No tener tarifas de avance</option>
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 5---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta5" name="pregunta5" class="text-bold form-control" value="4. ¿Ha tenido la experiencia de tomar un diferido especial anteriormente sea con Banco Pichincha u otra entidad?" readonly /></div>
                                                <div class="col-xs-3">
...
<script src="scripts/JS_BPEncuestaNoDiferidos.js" type="text/javascript"></script>
