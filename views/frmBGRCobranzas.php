                                ...
                                <div id="pnlEncuesta" class="col-xs-12 btn">
                                    <div class="box box-widget bg-gray">
                                        <div class="box-body">
                                            ...
                                            <div class="col-xs-10"><input id="pregunta9" name="pregunta9" class="text-bold form-control" value="Califique del 1 al 10 siendo 1 poco satisfecho y 10 muy satisfecho: Su grado de satisfacción con el servicio recibido en Cobranzas BGR" readonly/></div>
                                            <div class="col-xs-2">
                                            ...
                                            <div class="col-xs-10"><input id="pregunta5" name="pregunta5" class="text-bold form-control" value="Califique del 1 al 7: El oficial de Cobranzas que atendió su requerimiento, entendió su necesidad" readonly/></div>
                                            <div class="col-xs-2">
                                            ...
                                            <div class="col-xs-10"><input id="pregunta1" name="pregunta1" class="text-bold form-control" value="Califique del 1 al 7 siendo 1 malo y 7 excelente: Considera que la asesoría brindada por el oficial de Cobranzas fue efectiva" readonly/></div>
                                            <div class="col-xs-2">
                                            ...
                                            <div class="col-xs-10"><input id="pregunta10" name="pregunta10" class="text-bold form-control" value="¿Que tan fácil o sencillo es para usted gestionar su requerimiento en el departamento de Cobranzas?" readonly/></div>
                                            <div class="col-xs-2">
...
<script src="scripts/JS_BGRCobranza.js" type="text/javascript"></script>
