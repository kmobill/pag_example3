            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="text-bold">Cooperativa Santa Rosa de Patután</h4> </div>
                                        ...
                                        <div class="box box-widget bg-gray">
                                            <div class="box-body col-xs-12 btn">
                                                ...
                                                <div class="col-xs-3">
                                                    ...
                                                    <input type="number" id="respuesta1" name="respuesta1" class="text-bold form-control" />
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 2---------------------------------------------------->
                                                <div class="col-xs-6">
                                                    <input id="pregunta2" name="pregunta2" class="text-bold form-control" readonly value="Motivo del porqué se realiza el pago parcial (incompleto)"/>
                                                    <input type="text" id="respuesta2" name="respuesta2" class="text-bold form-control" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script src="scripts/JS_CoopPatutanCobranzas.js" type="text/javascript"></script>
