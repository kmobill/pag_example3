                                    ...
                                    <div id="pnlEncuesta" class="col-xs-12 btn">
                                        <div class="box box-widget bg-gray">
                                            <div class="box-body col-xs-12 btn">
                                                <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta1" name="pregunta1" class="text-bold form-control" value="1. Coménteme, ¿Cuál fue la razón por la cual no aceptó la asistencia: conductor protegido?" readonly/></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta1" name="respuesta1" class="form-control">
                                                        <option></option>
                                                        <option>No tengo vehículo </option>
                                                        <option>Tengo una asistencia similar</option>
                                                        <option>Es un gasto innecesario</option>
                                                    </select>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 2---------------------------------------------------->
                                                <div class="col-xs-6"><input id="pregunta2" name="pregunta2" class="text-bold form-control" value="2.1. ¿Cuál? " readonly /></div>
                                                <div class="col-xs-6">
                                                    <input id="respuesta2" name="respuesta2" class="form-control" maxlength="500"/>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 3---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta3" name="pregunta3" class="text-bold form-control" readonly value="2. Coméntenos cuantas veces al mes usted pone gasolina a su vehículo?"/></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta3" name="respuesta3" class="form-control">
                                                        <option></option>
                                                        <option>1 – 4 veces</option>
                                                        <option>4 – 8 veces</option>
                                                        <option>Más de 8 veces</option>
                                                    </select> 
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 4---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta4" name="pregunta4" class="text-bold form-control" value="3. Si tuviese que elegir una asistencia para su vehículo porque la elegiría?" readonly /></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta4" name="respuesta4" class="form-control">
                                                        ...
                                                        <option>Tasa preferencial</option>
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 5---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta5" name="pregunta5" class="text-bold form-control" value="4. Si usted pudiese elegir los beneficios de esta asistencia ¿Cuál escogería?" readonly /></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta5" name="respuesta5" class="form-control">
                                                        ...
                                                        <option>Respaldo</option>
                                                        <option>Auto sustituto</option>
                                                        <option>Servicio de carga de batería</option>
                                                        <option>Servicio de cambio de neumáticos</option>
                                                        <option>Cobertura</option>
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 6---------------------------------------------------->
                                                <div class="col-xs-6"><input id="pregunta6" name="pregunta6" class="text-bold form-control" value="4.1 ¿Porqué?" readonly /></div>
                                                <div class="col-xs-6">
                                                    <input id="respuesta6" name="respuesta6" class="form-control" maxlength="500"/>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 7---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta7" name="pregunta7" class="text-bold form-control" value="5. ¿Qué tipo de atributos consideraría atractivos para que pueda aceptar una asistencia para su vehículo?" readonly /></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta7" name="respuesta7" class="form-control">
                                                        ...
                                                        <option>Auxilio mecánico</option>
                                                        <option>Asistencia legal in situ</option>
                                                        <option>Asistencia en caso de accidentes</option>
                                                        <option>Asistencia en viajes</option>
                                                        <option>Conductor elegido</option>
                                                        <option>Ninguno</option>
                                                    </select>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 8---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta8" name="pregunta8" class="text-bold form-control" readonly value="6. ¿Cuáles son las razones por las que no aceptaría el conductor protegido?"/></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta8" name="respuesta8" class="form-control">
                                                        <option></option>
                                                        <option>Es muy caro</option>
                                                        <option>No tiene lo que requiero</option>
                                                        <option>No conozco la marca</option>
                                                        <option>No tengo buena experiencia con NOVA</option>
                                                    </select>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 9---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta9" name="pregunta9" class="text-bold form-control" readonly value="7. El pago que realizaría de una asistencia para su vehículo le parece mejor si fuera"/></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 10---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta10" name="pregunta10" class="text-bold form-control" value="8.- Que productos le gustaría recibir de parte de nosotros?" readonly /></div>
                                                <div class="col-xs-3">
...
<script src="scripts/JS_BPEncuestaNoAceptaAutomas.js" type="text/javascript"></script>
