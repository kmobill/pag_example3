                                ...
                                <div id="pnlEncuesta" class="col-xs-12 btn">
                                    <div class="box box-widget bg-gray">
                                        <div class="box-body">
                                            ...
                                            <div class="col-xs-10"><textarea rows="3" id="pregunta15" name="pregunta15" class="text-bold form-control" readonly></textarea></div>
                                            <div class="col-xs-2">
                                            ...
                                            <!---------------------------------------------------------PREGUNTA 15---------------------------------------------------->
                                            <!--<div class="col-xs-12"><label>PILAR - LEALTAD / ATRIBUTO - RECOMENDACIÓN</label></div>-->
                                            <div class="col-xs-12"><input id="pregunta19" name="pregunta19_1" class="text-bold form-control" readonly value="Cuéntenos que opciones, productos o servicios podemos incluir a futuro en nuestra Banca Digital" /></div>
                                            <div class="col-xs-12">
                                                <input id="respuesta19" name="respuesta19_1" type="text" class="form-control" maxlength="500">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script src="scripts/JS_BGRDigital_V2.js" type="text/javascript"></script>
