                                    ...
                                    <div id="pnlEncuesta" class="col-xs-12 btn">
                                        <div class="box box-widget bg-gray">
                                            <div class="box-body col-xs-12 btn">
                                                <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta1" name="pregunta1" class="text-bold form-control" value="1. ¿Qué tanta dificultad tuvo con la adquisición del Préstamo de Consumo de Banco Pichincha?" readonly/></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 3---------------------------------------------------->
                                                <div class="col-xs-9"><textarea rows="3" id="pregunta3" name="pregunta3" class="text-bold form-control" readonly>Pregunta 2. En la escala de 1 a 10 donde, donde “1 es Muy Insatisfecho y 10 Muy Satisfecho”, por favor califique: ¿Cuál fue su grado de satisfacción general con el proceso de adquisición del Préstamo de Consumo de Banco Pichincha.</textarea></div>
                                                <div class="col-xs-3">
...
<script src="scripts/JS_BPEncuestaPreciso.js" type="text/javascript"></script>
