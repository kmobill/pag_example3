                                    ...
                                    <div id="pnlEncuesta" class="col-xs-12 btn">
                                        <div class="box box-widget bg-gray">
                                            <div class="box-body col-xs-12 btn">
                                                <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta1" name="pregunta1" class="text-bold form-control" value="1.  Mantiene un crédito de vehicular activo con Banco Pichincha" readonly/></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 2---------------------------------------------------->
                                                <div class="col-xs-12"><input class="text-bold form-control" value="2. En orden de importancia siendo (1 el más importante y 5 el menos importante) indique que atributos de su crédito vehicular usted valora más actualmente" readonly /></div>
                                                <div class="col-xs-3"><input id="pregunta2" name="pregunta2" class="text-bold form-control" value="Tasa de interés" readonly /></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 3---------------------------------------------------->
                                                <div class="col-xs-3"><input id="pregunta3" name="pregunta3" class="text-bold form-control" readonly value="Monto del crédito que le da Banco Pichincha"/></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 4---------------------------------------------------->
                                                <div class="col-xs-3"><input id="pregunta4" name="pregunta4" class="text-bold form-control" value="Plazo de su crédito" readonly /></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 5---------------------------------------------------->
                                                <div class="col-xs-6"><input id="pregunta5" name="pregunta5" class="text-bold form-control" value="Meses de gracia para empezar a pagar su crédito " readonly /></div>
                                                <div class="col-xs-6">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 6---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta6" name="pregunta6" class="text-bold form-control" value="Plazo del seguro de su vehiculo" readonly /></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 7---------------------------------------------------->
                                                <div class="col-xs-12"><input class="text-bold form-control" value="3. En orden de importancia indique que aspectos del servicio de su crédito de vehicular valora más actualmente" readonly /></div>
                                                <div class="col-xs-9"><input id="pregunta7" name="pregunta7" class="text-bold form-control" value="Agilidad" readonly /></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 8---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta8" name="pregunta8" class="text-bold form-control" readonly value="Menos requisitos"/></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 9---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta9" name="pregunta9" class="text-bold form-control" readonly value="Asesoramiento"/></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 10---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta10" name="pregunta10" class="text-bold form-control" value="4. En que cree que deberia mejorar el crédito vehicular/ vehicular BIO Banco Pichincha" readonly /></div>
                                                <div class="col-xs-3">
...
<script src="scripts/JS_BPEncuestaVehicular1.js" type="text/javascript"></script>
