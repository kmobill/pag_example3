                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12">
                                ...
                                <div id="pnlEncuesta" class="col-xs-12 btn">
                                    <div class="box box-widget bg-gray">
                                        <div class="box-body">
                                            <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                            <div class="col-xs-10"><input id="pregunta1" name="pregunta1" class="text-bold form-control" value="1.	De los canales adicionales que BGR tiene a su disposición como Banco Pichincha o Servipagos, ¿Cuál es el de su preferencia?" readonly/></div>
                                            <div class="col-xs-2">
                                                <select id="respuesta1" name="respuesta1" class="form-control">
                                                    <option></option>
                                                    <option>Banco Pichincha</option>
                                                    <option>Servipagos</option>
                                                </select>
                                            </div>

                                            <!---------------------------------------------------------PREGUNTA 2---------------------------------------------------->
                                            <div class="col-xs-12"><label id="lbl">Con relación a Servipagos por favor responda las siguientes preguntas:</label></div>
                                            <div class="col-xs-10"><textarea id="pregunta2" name="pregunta2" class="text-bold form-control" readonly>2. ¿Que tan útil es para usted contar con la red de Servipagos para realizar sus transacciones de BGR? Siendo 1 nada útil y 10 muy útil</textarea></div>
                                            <div class="col-xs-2">
                                            ...
                                            <div class="col-xs-4">
                                                <input id="pregunta2_1" name="pregunta2_1" class="text-bold form-control" value="¿Cuál es el motivo de su calificación?" readonly />
                                            </div>
                                            <div class="col-xs-8">
                                                <input id="respuesta2_1" name="respuesta2_1" type="text" class="form-control" maxlength="500">
                                            </div>
                                            <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                            <div class="col-xs-10"><input id="pregunta3" name="pregunta3" class="text-bold form-control" value="3. Considera que disponer de la red Servipagos mejora su experiencia como cliente de BGR" readonly/></div>
                                            <div class="col-xs-2">
                                            ...
                                            <div class="col-xs-4">
                                                <input id="pregunta3_1" name="pregunta3_1" class="text-bold form-control" readonly value="" />
                                            </div>
                                            <div class="col-xs-8">
                                                <input id="respuesta3_1" name="respuesta3_1" type="text" class="form-control" maxlength="500">
                                            </div>
                                            <!---------------------------------------------------------PREGUNTA 4---------------------------------------------------->
                                            <div class="col-xs-12"><input id="pregunta4" name="pregunta4" class="text-bold form-control" value="4.	Si no contara con la red de Servipagos, a través de que canal realizaría sus transacciones de BGR?" readonly/></div>
                                            <div class="col-xs-12">
                                                <input id="respuesta4" name="respuesta4" class="text-bold form-control" maxlength="500" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script src="scripts/JS_BGRServipagos.js" type="text/javascript"></script>
