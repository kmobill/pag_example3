                                    ...
                                    <div id="pnlEncuesta" class="col-xs-12 btn">
                                        <div class="box box-widget bg-gray">
                                            <div class="box-body col-xs-12 btn">
                                                <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta1" name="pregunta1" class="text-bold form-control" value="1. ¿Cuál es el centro de acopio que atiende sus requerimientos (depósitos o retiros de efectivo)?" readonly/></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta1" name="respuesta1" class="form-control">
                                                        <option></option>
                                                        <option>CENTRO DE ACOPIO QUITO</option>
                                                        <option>CENTRO DE ACOPIO GUAYAQUIL</option>
                                                        <option>CENTRO DE ACOPIO CUENCA</option>
                                                    </select>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 2---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta2" name="pregunta2" class="text-bold form-control" value="2. ¿Cómo calificaría la atención del personal de la transportadora de FORTIUS?" readonly /></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 3---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta3" name="pregunta3" class="text-bold form-control" readonly value="3. ¿Qué recomendación daría usted a la transportadora FORTIUS para que el servicio de transporte sea el óptimo?"/></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 4---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta4" name="pregunta4" class="text-bold form-control" value="4. ¿Cómo calificaría la atención a sus requerimientos (depósitos - retiros de efectivo) por parte del Centro de Acopio de Banco Pichincha C.A.?" readonly /></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 5---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta5" name="pregunta5" class="text-bold form-control" value="5. ¿Cómo calificaría la atención a sus reclamos por parte del Centro de Acopio de Banco Pichincha C.A.? " readonly /></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 6---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta6" name="pregunta6" class="text-bold form-control" value="6. ¿Cómo calificaría la atención del personal del Centro de Acopio de Banco Pichincha C.A.?" readonly /></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 7---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta7" name="pregunta7" class="text-bold form-control" value="7. ¿Cómo calificaría la comunicación de novedades en sus depósitos realizados por parte del Centro de Acopio de Banco Pichincha C.A.? " readonly /></div>
                                                <div class="col-xs-3">
...
<script src="scripts/JS_BPEncuestaCentroAcopio1.js" type="text/javascript"></script>
