                                            ...
                                            <div class="box-body col-xs-12 btn">
                                                ...
                                                <div class="col-xs-3">
                                                    ...
                                                    <select id="respuesta6" name="respuesta6" class="form-control">
                                                        <option></option>
                                                        <option>AGENCIA MATRIZ</option>
                                                        <option>AGENCIA GUALACEO</option>
                                                        <option>VENTANILLA GUARAINAG</option>
                                                        <option>VENTANILLA SAN JUAN</option>
                                                    </select>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 3---------------------------------------------------->
                                                <div class="col-xs-12">
...
<script src="scripts/JS_CoopGañansolCobranzas.js" type="text/javascript"></script>
