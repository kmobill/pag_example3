            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header with-border"> <!-- header -->
                        <h1 class="box-title">Detalle por base </h1>
                    </div> <!-- /header -->
                    <div class="panel-body table-responsive" id="listadoRegistros"> <!-- listado de registros -->
                        <p class="col-xs-2"><b>Seleccione una base (importación):</b></p>
                        <div class="col-xs-3">
                            <input class="form-control" type="text" name="base" id="base" required />
                        </div>
...
<script src="scripts/detalleByBase.js" type="text/javascript"></script>