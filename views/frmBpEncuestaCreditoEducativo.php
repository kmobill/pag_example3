                                    ...
                                    <div id="pnlEncuesta" class="col-xs-12 btn">
                                        <div class="box box-widget bg-gray">
                                            <div class="box-body col-xs-12 btn">
                                                <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta1" name="pregunta1" class="text-bold form-control" value="1. La experiencia para obtener tu crédito educativo fue:" readonly/></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 2---------------------------------------------------->
                                                <div class="col-xs-12"><input id="pregunta2" name="pregunta2" class="text-bold form-control" readonly value="2. A que entidades recurriste durante la búsqueda del crédito para pagar tus estudios y por qué (indagar en la competencia)"/></div>
                                                <div class="col-xs-12">
                                                    <input type="text" id="respuesta2" name="respuesta2" class="form-control">
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 3---------------------------------------------------->
                                                <div class="col-xs-12"><input class="text-bold form-control" readonly value="3.	Que atributos son los que más valoras del crédito educativo, siendo 1 el más importante y 5 el menos importante"/></div>
                                                <div class="col-xs-9"><input id="pregunta3" name="pregunta3" class="text-bold form-control" readonly value="Tasa de interés"/></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 4---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta4" name="pregunta4" class="text-bold form-control" readonly value="Plazo de su crédito"/></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 5---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta5" name="pregunta5" class="text-bold form-control" readonly value="Meses de gracia"/></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 6---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta6" name="pregunta6" class="text-bold form-control" readonly value="Pre cancelación"/></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 7---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta7" name="pregunta7" class="text-bold form-control" readonly value="4. Como prefieres pagar tu crédito:"/></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta7" name="respuesta7" class="form-control">
                                                        <option></option>
                                                        <option>Después de terminar tus estudios</option>
                                                        <option>Mientras estas estudiando</option>
                                                    </select>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 8---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta8" name="pregunta8" class="text-bold form-control" readonly value="5. Valoras el atributo de empezar a pagar tu crédito 6 meses después de terminar tu carrera"/></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 9---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta9" name="pregunta9" class="text-bold form-control" readonly value="6. Quien influyo en la decisión de tu crédito Educativo"/></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta9" name="respuesta9" class="form-control">
                                                        <option></option>
                                                        <option>Padres</option>
                                                        <option>Hermanos</option>
                                                        <option>Fue una desición personal</option>
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 10---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta10" name="pregunta10" class="text-bold form-control" readonly value="6. Que tan complicado fue conseguir un garante para tu operación de crédito"/></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 11---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta11" name="pregunta11" class="text-bold form-control" readonly value="7. De qué manera prefieres gestionar tu crédito educativo"/></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta11" name="respuesta11" class="form-control">
                                                        <option></option>
                                                        <option>100% virtual</option>
                                                        <option>En agencia</option>
                                                        <option>Mixto</option>
                                                    </select>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 12---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta12" name="pregunta12" class="text-bold form-control" readonly value="8. Por medio de que canales te gustaría recibir información de tu crédito educativo"/></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta12" name="respuesta12" class="form-control">
                                                        ...
                                                        <option>Aplicación del banco</option>
                                                    </select>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 13---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta13" name="pregunta13" class="text-bold form-control" readonly value="9. En qué aspectos debería mejorar el producto"/></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta13" name="respuesta13" class="form-control">
                                                        <option></option>
                                                        <option>Menos requisitos</option>
                                                        <option>Tiempo de respuesta más rápido</option>
                                                        <option>Incluir cupo para compra de electrónicos/útiles</option>
                                                        <option>Eliminar la firma notarizada de los documentos</option>
                                                    </select>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 14---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta14" name="pregunta14" class="text-bold form-control" readonly value="10. Recomendarías a alguien obtener el crédito educativo en BP"/></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 15---------------------------------------------------->
                                                <div class="col-xs-3"><input id="pregunta15" name="pregunta15" class="text-bold form-control" readonly value="Porque"/></div>
                                                <div class="col-xs-9">
                                                    <input type="text" id="respuesta15" name="respuesta15" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script src="scripts/JS_BPEncuestaCreditoEducativo.js" type="text/javascript"></script>
