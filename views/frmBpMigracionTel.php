                                    ...
                                    <div id="pnlEncuesta" class="col-xs-12 btn">
                                        <div class="box box-widget bg-gray">
                                            <div class="box-body col-xs-12 btn">
                                                <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta1" name="pregunta1" class="text-bold form-control" value="1. DEL SIGUIENTE LISTADO DE CANALES ALTERNATIVOS CUÁL  HA USADO ÚLTIMAMENTE" readonly/></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 2---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta2" name="pregunta2" class="text-bold form-control" value="2. QUÉ TANTA DIFICULTAD TUVO AL UTILIZAR ESTE CANAL?" readonly /></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 3---------------------------------------------------->
                                                <div class="col-xs-6"><input id="pregunta3" name="pregunta3" class="text-bold form-control" readonly value="3. PUEDE COMPARTIR CON NOSOTROS LA RAZON DE SU CALIFICACION?"/></div>
                                                <div class="col-xs-6">
                                                    <input id="respuesta3" name="respuesta3" class="form-control" maxlength="500"/>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 4---------------------------------------------------->
                                                <div class="col-xs-6"><input id="pregunta4" name="pregunta4" class="text-bold form-control" value="4. ¿QUÉ CONSIDERA USTED QUE BANCO PICHINCHA NECESITA MEJORAR EN EL CANAL UTILIZADO?" readonly /></div>
                                                <div class="col-xs-6">
...
<script src="scripts/JS_BPEncuestaMigracionTel.js" type="text/javascript"></script>
