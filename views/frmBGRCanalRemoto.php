                                    ...
                                    <div id="pnlEncuesta" class="col-xs-12 btn">
                                        <div class="box box-widget bg-gray">
                                            <div class="box-body col-xs-12 btn">
                                                <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta1" name="pregunta1" class="text-bold form-control" value="1. ¿El requerimiento por el cual se contactó al canal virtual fue resuelto?" readonly/></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 2---------------------------------------------------->
                                                <div class="col-xs-4"><input id="pregunta2" name="pregunta2" class="text-bold form-control" value="¿Por qué?" readonly /></div>
                                                <div class="col-xs-8">
                                                    <input id="respuesta2" name="respuesta2" type="text" class="form-control" maxlength="500">
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 3---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta3" name="pregunta3" class="text-bold form-control" value="2. En una escala del 1 al 10 que tan satisfecho se encuentra con la atención recibida en el canal virtual de BGR" readonly /></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 4---------------------------------------------------->
                                                <div class="col-xs-4"><input id="pregunta4" name="pregunta4" class="text-bold form-control" readonly /></div>
                                                <div class="col-xs-8">
                                                    <input id="respuesta4" name="respuesta4" type="text" class="form-control" maxlength="500">
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 5---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta5" name="pregunta5" class="text-bold form-control" readonly value="3. ¿Qué tan fácil fue gestionar su trámite en nuestro canal Virtual de BGR?"/></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 6---------------------------------------------------->
                                                <div class="col-xs-4"><input id="pregunta6" name="pregunta6" class="text-bold form-control" readonly /></div>
                                                <div class="col-xs-8">
                                                    <input id="respuesta6" name="respuesta6" type="text" class="form-control" maxlength="500">
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 7---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta7" name="pregunta7" class="text-bold form-control" value="4. En una escala del 0 al 10 en que grado recomendaría a familiar, amigo o colega, ¿Realizar sus requerimientos con el canal virtual?" readonly /></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 8---------------------------------------------------->
                                                <div class="col-xs-4"><input id="pregunta8" name="pregunta8" class="text-bold form-control" readonly /></div>
                                                <div class="col-xs-8">
                                                    <input id="respuesta8" name="respuesta8" type="text" class="form-control" maxlength="500">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script src="scripts/JS_BGRCanalesRemotos.js" type="text/javascript"></script>
