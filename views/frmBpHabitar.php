                                    ...
                                    <div id="pnlEncuesta" class="col-xs-12 btn">
                                        <div class="box box-widget bg-gray">
                                            <div class="box-body col-xs-12 btn">
                                                <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta1" name="pregunta1" class="text-bold form-control" value="1. Mantiene un crédito de vivienda activo con Banco Pichincha" readonly/></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 2---------------------------------------------------->
                                                <div class="col-xs-12"><input class="text-bold form-control" readonly value="2. En que orden de importancia indique que atributos de su crédito de vivienda usted valora más actualmente"/></div>
                                                <div class="col-xs-9"><input id="pregunta2" name="pregunta2" class="text-bold form-control" readonly value="Tasa de interés"/></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 3---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta3" name="pregunta3" class="text-bold form-control" readonly value="Monto del crédito que le da Banco Pichincha"/></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 5---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta5" name="pregunta5" class="text-bold form-control" readonly value="Meses de gracia para empezar a pagar su crédito"/></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 6---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta6" name="pregunta6" class="text-bold form-control" readonly value="Bono en efectivo para ser utilizado en su nueva vivienda"/></div>
                                                <div class="col-xs-3">
                                                ...
                                                <div class="col-xs-12"><input class="text-bold form-control" readonly value="2. En que orden de importancia indique que aspectos del servicio de su crédito de vivienda valora más actualmente"/></div>
                                                <!---------------------------------------------------------PREGUNTA 7---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta7" name="pregunta7" class="text-bold form-control" readonly value="Agilidad"/></div>
                                                <div class="col-xs-3">
...
<script src="scripts/JS_BPEncuestaHabitar.js" type="text/javascript"></script>
