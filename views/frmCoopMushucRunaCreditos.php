            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="text-bold">Cooperativa Mushuc Runa - Créditos</h4> </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12">
                                <div class="box box-widget">
                                    ...
                                    <div class="col-xs-12 btn bg-gray-light">
                                        ...
                                        <div class="col-xs-4"> <b>AGENCIA </b>
                                        ...
                                        <div class="col-xs-2"> <b>TIPO_EMPLEADO </b>
                                        ...
                                        <div class="col-xs-2"> <b>OFICIAL_CUENTA </b>
                                            <input type="text" class="form-control input-sm" id="OFICIAL_CUENTA" name="OFICIAL_CUENTA" readonly/>
                                        </div>
                                        <div class="col-xs-2"> <b>TIPO_CREDITO </b>
                                            <input type="text" class="form-control input-sm" id="TIPO_CREDITO" name="TIPO_CREDITO" readonly/>
                                        </div>
                                    ...
                                    <div id="pnlEncuesta" class="col-xs-12 btn">
                                        <div class="box box-widget bg-gray">
                                            <div class="box-body col-xs-12 btn">
                                                <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                                <div class="col-xs-9"><input class="text-bold form-control" value="Fecha de agenda:" readonly/></div>
                                                <div class="col-xs-3">
                                                    <input type="date" id="FECHA_AGENDA_CRD" name="FECHA_AGENDA_CRD" class="text-bold form-control" readonly/>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 2---------------------------------------------------->
                                                <div class="col-xs-9"><input class="text-bold form-control" readonly value="Hora de agenda:"/></div>
                                                <div class="col-xs-3">
                                                    <input type="time" id="HORA_AGENDA_CRD" name="HORA_AGENDA_CRD" class="text-bold form-control" readonly/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script src="scripts/JS_CoopMushucRunaCreditos.js" type="text/javascript"></script>
