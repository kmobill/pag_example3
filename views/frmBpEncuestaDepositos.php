                                    ...
                                    <div id="pnlEncuesta" class="col-xs-12 btn">
                                        <div class="box box-widget bg-gray">
                                            <div class="box-body col-xs-12 btn">
                                                <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta1" name="pregunta1" class="text-bold form-control" value="1. ¿Sabía usted que puede realizar (A/ B) en nuestros equipos Depositarios?" readonly/></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 2---------------------------------------------------->
                                                <div class="col-xs-6"><input id="pregunta2" name="pregunta2" class="text-bold form-control" value="1.2 ¿cómo se enteró que podía realizar depósitos?" readonly /></div>
                                                <div class="col-xs-6">
                                                    <input id="respuesta2" name="respuesta2" class="form-control" maxlength="500"/>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 3---------------------------------------------------->
                                                <div class="col-xs-6"><input id="pregunta3" name="pregunta3" class="text-bold form-control" readonly value="3. ¿Por qué prefiere ir a la ventanilla y no al Depositario para realizar (A/B)?"/></div>
                                                <div class="col-xs-6">
                                                    <input id="respuesta3" name="respuesta3" class="form-control" maxlength="500"/> 
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 4---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta4" name="pregunta4" class="text-bold form-control" value="4. ¿Qué le preocupa o no le gusta de los depositarios?" readonly /></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta4" name="respuesta4" class="form-control">
                                                        <option></option>
                                                        <option>Bioseguridad</option>
                                                        <option>Fallas en el equipo</option>
                                                        <option>Seguridad / delincuencia</option>
                                                        <option>Falta de conocimiento de cómo operan</option>
                                                        <option>Que no se realicen los depósitos</option>
                                                    </select>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 5---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta5" name="pregunta5" class="text-bold form-control" value="5. Durante el mes de Marzo usted recibió un correo electrónico con los pasos para depositar en los cajeros, lo recuerda?" readonly /></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 6---------------------------------------------------->
                                                <div class="col-xs-6"><input id="pregunta6" name="pregunta6" class="text-bold form-control" value="6. ¿Le pareció que el correo era claro?" readonly /></div>
                                                <div class="col-xs-6">
                                                    <input id="respuesta6" name="respuesta6" class="form-control" maxlength="500"/>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 7---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta7" name="pregunta7" class="text-bold form-control" value="7. ¿Fue de su agrado recibir este tipo de correo?" readonly /></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 8---------------------------------------------------->
                                                <div class="col-xs-6"><input id="pregunta8" name="pregunta8" class="text-bold form-control" readonly value="7.1 ¿Por qué?"/></div>
                                                <div class="col-xs-6">
                                                    <input id="respuesta8" name="respuesta8" class="form-control" maxlength="500"/>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 9---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta9" name="pregunta9" class="text-bold form-control" readonly value="8. ¿Por qué medio le gustaría conocer de tips o novedades de nuestros cajeros automáticos?"/></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 10---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta10" name="pregunta10" class="text-bold form-control" value="9.	Le gustaría que comuniquemos lo mismo por:" readonly /></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta10" name="respuesta10" class="form-control">
                                                        <option></option>
                                                        <option>Influencers o personajes famosos que expliquen cómo realizar un (A/ B)</option>
                                                        <option>Videos cortos a su Whatsapp cómo realizar un (A/ B)</option>
                                                        <option>Videos en la TV cómo realizar un (A/ B)</option>
                                                        <option>Videos en Redes Sociales de cómo realizar un (A/ B)</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
...
<script src="scripts/JS_BPEncuestaDepositos.js" type="text/javascript"></script>
