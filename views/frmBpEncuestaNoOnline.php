                                    ...
                                    <div id="pnlEncuesta" class="col-xs-12 btn">
                                        <div class="box box-widget bg-gray">
                                            <div class="box-body col-xs-12 btn">
                                                <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta1" name="pregunta1" class="text-bold form-control" value="1. ¿Cuál o cuáles fue(ron) la razón por la cual no aceptó este desembolso?" readonly/></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta1" name="respuesta1" class="form-control">
                                                        <option></option>
                                                        <option>Necesito un monto mayor</option>
                                                        <option>No necesito en este momento</option>
                                                        <option>Tengo créditos en otras instituciones</option>
                                                        <option>Prefiero ir a la agencia</option>
                                                        <option>Ya tomé una oferta de crédito hace pocos meses</option>
                                                        <option>Tengo crédito vigente con Banco Pichincha</option>
                                                        <option>Desconfío de estos canales digitales para hacer transacciones</option>
                                                        <option>No tiene documentos</option>
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 3---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta3" name="pregunta3" class="text-bold form-control" readonly value="2. Si usted pudiese elegir los beneficios de un crédito ¿Cuál o cuáles escogería?"/></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta3" name="respuesta3" class="form-control">
                                                        ...
                                                        <option>Plazos ajustados a mi presupuesto</option>
                                                        <option>Pre cancelación de deudas</option>
                                                        <option>Desarrollo de un proyecto productivo</option>
                                                        <option>Beneficios adicionales</option>
                                                        <option>Descuentos</option>
                                                    </select> 
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 4---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta4" name="pregunta4" class="text-bold form-control" value="3. ¿A través de qué canal siente más confianza para aceptar este tipo de oferta?" readonly /></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta4" name="respuesta4" class="form-control">
                                                        <option></option>
                                                        <option>Directamente en agencia</option>
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 5---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta5" name="pregunta5" class="text-bold form-control" value="4. ¿Ha tenido la experiencia de tomar un crédito de esta naturaleza anteriormente sea con Banco Pichincha u otra entidad?" readonly /></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 6---------------------------------------------------->
                                                <div class="col-xs-6"><input id="pregunta6" name="pregunta6" class="text-bold form-control" value="4.1 ¿Cómo fue su experiencia?" readonly /></div>
                                                <div class="col-xs-6">
                                                    <input id="respuesta6" name="respuesta6" class="form-control" maxlength="500"/>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 7---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta7" name="pregunta7" class="text-bold form-control" value="5. Que productos le gustaría recibir de parte de nosotros?" readonly /></div>
                                                <div class="col-xs-3">
...
<script src="scripts/JS_BPEncuestaNoOnline.js" type="text/javascript"></script>
