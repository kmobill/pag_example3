                                    ...
                                    <div id="pnlEncuesta" class="col-xs-12 btn">
                                        <div class="box box-widget bg-gray">
                                            <div class="box-body col-xs-12 btn">
                                                <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta1" name="pregunta1" class="text-bold form-control" value="1.- ¿Cuál fue la razón por la cual no aceptó el Seguro Plan Deuda Protegida?" readonly/></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta1" name="respuesta1" class="form-control">
                                                        <option></option>
                                                        <option>Es muy costoso</option>
                                                        <option>No conoce los beneficios</option>
                                                        <option>Lo considero innecesario</option>
                                                        <option>Mala experiencia con NOVA en seguros en general</option>
                                                        <option>Mala experiencia con NOVA con el producto</option>
                                                        <option>No tengo acceso al efectivo express</option>
                                                        <option>Las coberturas no son suficientes</option>
                                                        <option>Situación económica</option>
                                                        <option>Ya tengo otro seguro</option>
                                                    </select>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 2---------------------------------------------------->
                                                <div class="col-xs-6"><input id="pregunta2" name="pregunta2" class="text-bold form-control" value="1.1. ¿Me podría indicar cuál?" readonly /></div>
                                                <div class="col-xs-6">
                                                    <input id="respuesta2" name="respuesta2" class="form-control" maxlength="500"/>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 3---------------------------------------------------->
                                                <div class="col-xs-6"><input id="pregunta3" name="pregunta3" class="text-bold form-control" value="1.2. ¿Qué coberturas tiene su actual seguro?" readonly /></div>
                                                <div class="col-xs-6">
                                                    <input id="respuesta3" name="respuesta3" class="form-control" maxlength="500"/>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 4---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta4" name="pregunta4" class="text-bold form-control" readonly value="2.- Si usted pudiese elegir los beneficios de un seguro para la deuda de su tarjeta ¿Cuál escogería?"/></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta4" name="respuesta4" class="form-control">
                                                        <option></option>
                                                        <option>Descuentos en pruebas COVID</option>
                                                        <option>Descuentos en exámenes médicos</option>
                                                        <option>Laboratorio a domicilio (grupo familiar) una cita mes</option>
                                                        <option>Servicios odontológicos básicos (limpieza) free o un dcto en otros servicios</option>
                                                        <option>Exámenes visuales</option>
                                                        <option>Descuentos en compra de medicina</option>
                                                        <option>Valores diferenciados por categoría y cupo de la tarjeta</option>
                                                        <option>Coberturas más amplias</option>
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 6---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta6" name="pregunta6" class="text-bold form-control" value="3.- ¿Qué tipo de atributos consideraría atractivos para que pueda aceptar un seguro para su tarjeta?" readonly /></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta6" name="respuesta6" class="form-control">
                                                        <option></option>
                                                        <option>Coberturas especificas</option>
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 7---------------------------------------------------->
                                                <div class="col-xs-6"><input id="pregunta7" name="pregunta7" class="text-bold form-control" value="3.1.- ¿Cuáles?" readonly /></div>
                                                <div class="col-xs-6">
                                                    <input id="respuesta7" name="respuesta7" class="form-control" maxlength="500"/>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 8---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta8" name="pregunta8" class="text-bold form-control" value="4.- El pago que realizaría de seguro para su tarjeta le parece mejor si fuera" readonly /></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 6---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta9" name="pregunta9" class="text-bold form-control" value="5.- Que productos le gustaría recibir de parte de nosotros?" readonly /></div>
                                                <div class="col-xs-3">
...
<script src="scripts/JS_BPEncuestaNoAceptaPDPConversion.js" type="text/javascript"></script>
