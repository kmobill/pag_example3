                            ...
                            <div id="pnlEncuesta" class="col-xs-12 btn">
                                <div class="box box-widget bg-gray">
                                    <div class="box-body">
                                        ...
                                        <div class="col-xs-10"><input id="pregunta1" name="pregunta1" class="text-bold form-control" readonly value="Califique del 1 al 7: Los servicios presentados en la banca Digital para la solución de su requerimiento"/></div>
                                        <div class="col-xs-2">
                                        ...
                                        <div class="col-xs-10"><input id="pregunta2" name="pregunta2" class="text-bold form-control" readonly value="Califique del 1 al 7: Si la información presentada en la banca Digital fue clara"/></div>
                                        <div class="col-xs-2">
                                        ...
                                        <div class="col-xs-10"><input id="pregunta3" name="pregunta3" class="text-bold form-control" readonly value="Califique del 1 al 7: ¿Qué tan útil es la información que se presenta en la banca digital?"/></div>
                                        <div class="col-xs-2">
...
<!--                                        <div class="col-xs-12"><label id="pilar4">PILAR - SERVICIO / ATRIBUTO - Actitud</label></div>
                                        <div class="col-xs-10"><input id="pregunta4" name="pregunta4" class="text-bold form-control" readonly value=""/></div>
                                        <div class="col-xs-2">
...
<!--                                        <div class="col-xs-12"><label id="pilar6">PILAR - SERVICIO / ATRIBUTO - Efectividad </label></div>
                                        ...
                                        <div class="col-xs-10"><input id="pregunta7" name="pregunta7" class="text-bold form-control" readonly value="Califique del 1 al 7: Los servicios disponibles en la banca digital cubren sus necesidades."/></div>
                                        <div class="col-xs-2">
...
<!--                                        <div class="col-xs-12"><label id="pilar11">PILAR - DIGITAL / ATRIBUTO - Accesibilidad (Empoderamiento al cliente)</label></div>
                                        ...
                                        <div class="col-xs-10"><input id="pregunta12" name="pregunta12" class="text-bold form-control" readonly value="Califique del 1 al 7: El nivel de innovación que ve en la banca digital"/></div>
                                        <div class="col-xs-2">
                                        ...
                                        <div class="col-xs-10"><input id="pregunta14" name="pregunta14" class="text-bold form-control" readonly value="¿Qué tan fácil es para usted realizar una transacción/consulta en la banca digital?"/></div>
                                        <div class="col-xs-2">
                                        ...
                                        <div class="col-xs-10"><input id="pregunta16" name="pregunta16" class="text-bold form-control" readonly value="¿Considera que el cambio a la nueva plataforma generó más comodidad y facilidad al momento acceder y realizar sus transacciones?" /></div>
                                        <div class="col-xs-2">
                                        ...
                                        <div class="col-xs-4">
                                            <input id="pregunta16_1" name="pregunta16_1" class="text-bold form-control" readonly value="¿Porque?" />
                                        </div>
                                        <div class="col-xs-8">
                                            <input id="respuesta16_1" name="respuesta16_1" type="text" class="form-control" maxlength="500">
                                        </div>
                                        <!---------------------------------------------------------PREGUNTA 17---------------------------------------------------->
<!--                                        <div class="col-xs-12"><label>PILAR - LEALTAD / ATRIBUTO - RECOMENDACIÓN</label></div>-->
                                        <div class="col-xs-12"><input id="pregunta17" name="pregunta17" class="text-bold form-control" readonly value="Cuéntenos que opciones podemos incluir a futuro en nuestra Banca Digital" /></div>
                                        <div class="col-xs-12">
                                            <input id="respuesta17" name="respuesta17" type="text" class="form-control" maxlength="500">
                                        </div>
                                        <!---------------------------------------------------------PREGUNTA 15---------------------------------------------------->
                                        <!--<div class="col-xs-12"><label>PILAR - LEALTAD / ATRIBUTO - RECOMENDACIÓN</label></div>-->
                                        <div class="col-xs-12"><input id="pregunta18" name="pregunta18" class="text-bold form-control" readonly value="Alguna sugerencia final que nos pueda dar para mejorar nuestra Banca Digital" /></div>
                                        <div class="col-xs-12">
                                            <input id="respuesta18" name="respuesta18" type="text" class="form-control" maxlength="500">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script src="scripts/bancoBGRDigital.js" type="text/javascript"></script>
