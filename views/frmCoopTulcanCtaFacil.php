            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="text-bold">Campaña Cooperativa Tulcán</h4> </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12">
                                <div class="box box-widget">
                                    ...
                                    <div class="col-xs-12 btn bg-gray-light">
                                        ...
                                        <div class="col-xs-2"> <b>NÚMERO CTA </b>
                                    ...
                                    <div id="pnlEncuesta" class="col-xs-12 btn">
                                        <div class="box box-widget bg-gray">
                                            <div class="box-body col-xs-12 btn">
                                                <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta1" name="pregunta1" class="text-bold form-control" value="1. Agencia a la que el socio se acercará" readonly/></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta1" name="respuesta1" class="form-control">
                                                        <option></option>
                                                        <option>TULCÁN</option>
                                                        <option>JULIO ANDRADE</option>
                                                        <option>HUACA</option>
                                                        <option>SAN GABRIEL</option>
                                                        <option>EL ANGEL</option>
                                                        <option>IBARRA</option>
                                                        <option>QUITO NORTE</option>
                                                        <option>QUITO CENTRO</option>
                                                        <option>QUITO SUR</option>
                                                        <option>SANGOLQUI</option>
                                                        <option>CAYAMBE</option>
                                                        <option>LATACUNGA</option>
                                                    </select>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 2---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta2" name="pregunta2" class="text-bold form-control" value="2. Fecha en la que el socio se acercará a la agencia" readonly /></div>
                                                <div class="col-xs-3">
...
<script src="scripts/JS_CoopTulcanCtaFacil.js" type="text/javascript"></script>
