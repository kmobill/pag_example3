                                    ...
                                    <div id="pnlEncuesta" class="col-xs-12 btn">
                                        <div class="box box-widget bg-gray">
                                            <div class="box-body col-xs-12 btn">
                                                <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                                <div class="col-xs-9"><textarea id="pregunta1" name="pregunta1" class="text-bold form-control">1. En la escala de 1 a 10, donde “1 es Muy Insatisfecho y 10 Muy Satisfecho”, por favor califique: Su grado de satisfacción general con el servicio que le brindaron en su reclamo por la devolución de consumo no reconocido realizado con su tarjeta de débito de Banco Pichincha.</textarea></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 2---------------------------------------------------->
                                                <div class="col-xs-6"><input id="pregunta2" name="pregunta2" class="text-bold form-control" value="1.1 ¿Cuál es el motivo de su calificación?" readonly /></div>
                                                <div class="col-xs-6">
                                                    <input id="respuesta2" name="respuesta2" class="form-control" maxlength="500"/>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 3---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta3" name="pregunta3" class="text-bold form-control" readonly value="2. ¿El ejecutivo le explicó de manera clara el proceso de su reclamo? "/></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 4---------------------------------------------------->
                                                <div class="col-xs-6"><input id="pregunta4" name="pregunta4" class="text-bold form-control" value="2.1 ¿Por qué?" readonly /></div>
                                                <div class="col-xs-6">
                                                    <input id="respuesta4" name="respuesta4" class="form-control" maxlength="500"/>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 5---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta5" name="pregunta5" class="text-bold form-control" value="3. ¿Está de acuerdo con el tiempo de respuesta que tomará su caso? " readonly /></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 6---------------------------------------------------->
                                                <div class="col-xs-6"><input id="pregunta6" name="pregunta6" class="text-bold form-control" value="3.1 ¿Por qué?" readonly /></div>
                                                <div class="col-xs-6">
                                                    <input id="respuesta6" name="respuesta6" class="form-control" maxlength="500"/>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 7---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta7" name="pregunta7" class="text-bold form-control" value="4. ¿Qué tanta dificultad tuvo en el proceso de su reclamo por la devolución de consumo no reconocido realizado con su tarjeta de débito de Banco Pichincha?" readonly /></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 8---------------------------------------------------->
                                                <div class="col-xs-6"><input id="pregunta8" name="pregunta8" class="text-bold form-control" readonly value="4.1 ¿Cuál es el motivo de su calificación? "/></div>
                                                <div class="col-xs-6">
...
<script src="scripts/JS_BPEncuestaPagoAnticipado.js" type="text/javascript"></script>
