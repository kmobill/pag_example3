                                    ...
                                    <div id="pnlEncuesta" class="col-xs-12 btn">
                                        <div class="box box-widget bg-gray">
                                            <div class="box-body col-xs-12 btn">
                                                <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta1" name="pregunta1" class="text-bold form-control" value="1.- Sr./Sra./Srta. XXX nos podría indicar si ya utilizado la tarjeta de crédito?" readonly/></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 2---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta2" name="pregunta2" class="text-bold form-control" value="2.- ¿Se encuentra satisfecho (a) con el producto Tarjeta Crédito?" readonly /></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 3---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta3" name="pregunta3" class="text-bold form-control" readonly value="3.- ¿Nos podría indicar si el motivo es por?"/></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta3" name="respuesta3" class="form-control">
                                                        <option></option>
                                                        <option>Costos</option>
                                                        <option>Demora en la entrega</option>
                                                        <option>Inconveniente en el momento de la compra</option>
                                                        <option>Tasas de interés</option>
                                                    </select>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 4---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta4" name="pregunta4" class="text-bold form-control" value="4.- ¿Nos podría indicar que información le gustaría recibir de su tarjeta para un mejor uso?" readonly /></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta4" name="respuesta4" class="form-control">
                                                        <option></option>
                                                        <option>Información sobre el Plan de Recompensas</option>
                                                        <option>Información sobre las compras con pagos diferidos o corrientes</option>
                                                        <option>Información sobre cómo realizar los pagos a su tarjeta</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
...
<script src="scripts/JS_BPEncuestaEducacionFinanciera.js" type="text/javascript"></script>
