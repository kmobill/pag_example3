                                    ...
                                    <div id="pnlEncuesta" class="col-xs-12 btn">
                                        <div class="box box-widget bg-gray">
                                            <div class="box-body col-xs-12 btn">
                                                <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta1" name="pregunta1" class="text-bold form-control" value="1. ¿De los productos que usted ha tenido con nosotros, cuál le ha brindado mayores beneficios?" readonly/></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta1" name="respuesta1" class="form-control">
                                                        ...
                                                        <option>Crédito Consumo</option>
                                                        <option>Tarjeta de Crédito</option>
                                                    </select>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 2---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta2" name="pregunta2" class="text-bold form-control" value="2. ¿Qué necesidad o producto desea actualmente, en la que Banco Pichincha le pueda ayudar?" readonly /></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 3---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta3" name="pregunta3" class="text-bold form-control" readonly value="3. ¿Cómo califica el nivel de servicio que ha recibo por parte del banco, desde la adquisición de su primer producto?"/></div>
                                                <div class="col-xs-3">
...
<script src="scripts/JS_BPEncuestaDesercion.js" type="text/javascript"></script>
