            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="text-bold">Saludsa</h4> </div>
                                    ...
                                    <div id="pnlEncuesta" class="col-xs-12 btn">
                                        <div class="box box-widget bg-gray">
                                            <div class="box-body col-xs-12 btn">
                                                <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                                <div class="col-xs-9"><input class="text-bold form-control" value="Identificacion del cliente" readonly/></div>
                                                <div class="col-xs-3">
                                                    <input type="number" pattern="^[0-9]+" id="respuesta1" name="respuesta1" class="text-bold form-control" readonly/>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 2---------------------------------------------------->
                                                <div class="col-xs-9"><input class="text-bold form-control" value="Tipo plan" readonly/></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta2" name="respuesta2" class="form-control">
                                                        <option></option>
                                                        <option>Único</option>
                                                        <option>Esencial 3D</option>
                                                        <option>Practico 3D</option>
                                                        <option>Práctico 3</option>
                                                        <option>Ideal 4D</option>
                                                        <option>Ideal 4</option>
                                                        <option>Élite 5D</option>
                                                        <option>Élite 5</option>
                                                        <option>Privilegio 7D</option>
                                                        <option>Privilegio 7</option>
                                                        <option>Privilegio Plus 8D</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
...
<script src="scripts/JS_Saludsa.js" type="text/javascript"></script>
