                                    ...
                                    <div id="pnlEncuesta" class="col-xs-12 btn">
                                        <div class="box box-widget bg-gray">
                                            <div class="box-body col-xs-12 btn">
                                                <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta1" name="pregunta1" class="text-bold form-control" value="1. ¿Qué tanta dificultad tuvo para adquirir su cuenta de Banco Pichincha?" readonly/></div>
                                                <div class="col-xs-3">
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 3---------------------------------------------------->
                                                <div class="col-xs-9"><textarea rows="3" id="pregunta3" name="pregunta3" class="text-bold form-control" readonly>2. Cuénteme, en una escala de 1 a 10 donde, donde “1 es Muy Insatisfecho y 10 Muy Satisfecho”, ¿cuál fue su grado de satisfacción general con con la cuenta creada en Banco Pichincha?</textarea></div>
                                                <div class="col-xs-3">
...
<script src="scripts/JS_BPEncuestaCuentas.js" type="text/javascript"></script>
