                                ...
                                <div id="pnlEncuesta" class="col-xs-12 btn">
                                    <div class="box box-widget bg-gray">
                                        <div class="box-body">
                                            ...
                                            <div class="col-xs-10"><input id="pregunta5" name="pregunta5" class="text-bold form-control" value="Califique del 1 al 7: Considera que su asesor de inversiones entendió su necesidad" readonly/></div>
                                            <div class="col-xs-2">
                                            ...
                                            <div class="col-xs-10"><input id="pregunta7" name="pregunta7" class="text-bold form-control" value="Califique del 1 al 7: La solución que recibió de su asesor de inversiones cumplió sus expectativas" readonly/></div>
                                            <div class="col-xs-2">
                                            ...
                                            <div class="col-xs-10"><input id="pregunta10" name="pregunta10" class="text-bold form-control" value="¿Que tan fácil o sencillo es para usted gestionar su requerimiento relacionado a su Inversión con BGR?" readonly/></div>
                                            <div class="col-xs-2">
...
<script src="scripts/JS_BGRInversion.js" type="text/javascript"></script>
