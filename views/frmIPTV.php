            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="text-bold">Campaña IP TV</h4> </div>
                                    ...
                                    <div id="pnlEncuesta" class="col-xs-12 btn">
                                        <div class="box box-widget bg-gray">
                                            <div class="box-body col-xs-12 btn">
                                                <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta1" name="pregunta1" class="text-bold form-control" value="1. Tipo de plan" readonly/></div>
                                                <div class="col-xs-3">
                                                    <select id="respuesta1" name="respuesta1" class="form-control">
                                                        <option></option>
                                                        <option>1 MES / $ 5,00</option>
                                                        <option>3 MESES / $ 12,99</option>
                                                        <option>6 MESES / $ 23,99</option>
                                                        <option>9 MESES / $ 32,99</option>
                                                        <option>12 MESES / $ 40,00</option>
                                                    </select>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 2---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta2" name="pregunta2" class="text-bold form-control" value="2. Correo electrónico" readonly /></div>
                                                <div class="col-xs-3">
                                                    <input type="email" id="respuesta2" name="respuesta2" class="text-bold form-control" />
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 3---------------------------------------------------->
                                                <div class="col-xs-9"><input id="pregunta3" name="pregunta3" class="text-bold form-control" value="2. Cuenta a la que transferencia" readonly /></div>
                                                <div class="col-xs-3">
                                                    <input type="number" id="respuesta3" name="respuesta3" class="text-bold form-control" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script src="scripts/JS_IPTV.js" type="text/javascript"></script>
