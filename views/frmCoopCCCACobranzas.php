                                    ...
                                    <div id="pnlEncuesta" class="col-xs-12 btn">
                                        <div class="box box-widget bg-gray">
                                            <div class="box-body col-xs-12 btn">
                                                <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                                <div class="col-xs-2">
                                                    <input id="pregunta1" name="pregunta1" class="text-bold form-control" value="Tipo acuerdo de pago" readonly/>
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 2---------------------------------------------------->
                                                <div class="col-xs-2">
                                                    <input id="pregunta2" name="pregunta2" class="text-bold form-control" value="Valor a cancelar" readonly/>
                                                    <input type="number" id="respuesta2" name="respuesta2" class="text-bold form-control" />
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 5---------------------------------------------------->
                                                <div class="col-xs-2">
                                                    <input id="pregunta5" name="pregunta5" class="text-bold form-control" value="Forma de pago" readonly/>
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 3---------------------------------------------------->
                                                <div class="col-xs-2">
                                                    <input id="pregunta3" name="pregunta3" class="text-bold form-control" value="Fecha de pago" readonly/>
                                                    <input type="date" id="respuesta3" name="respuesta3" class="text-bold form-control" />
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 4---------------------------------------------------->
                                                <div class="col-xs-2">
                                                    <input id="pregunta4" name="pregunta4" class="text-bold form-control" value="Observaciones" readonly/>
                                                    <select id="respuesta4" name="respuesta4" class="form-control">
                                                        <option></option>
                                                        <option>Lleno formulario</option>
                                                        <option>No lleno formulario</option>
                                                        <option>Se acercará a la agencia</option>
                                                    </select>
                                                </div>
                                                <!---------------------------------------------------------PREGUNTA 6---------------------------------------------------->
                                                <div class="col-xs-2">
                                                    <input id="pregunta6" name="pregunta6" class="text-bold form-control" value="Agencia" readonly/>
                                                    <select id="respuesta6" name="respuesta6" class="form-control">
                                                        <option></option>
                                                        <option>AMBATO MATRIZ</option>
                                                        <option>VENTANILLA FICOA AMBATO</option>
                                                        <option>CENTRO FINANCIERO</option>
                                                        <option>BAÑOS</option>
                                                        <option>PELILEO</option>
                                                        <option>PILLARO</option>
                                                        <option>GUAYAQUIL</option>
                                                        <option>GUARANDA</option>
                                                        <option>QUITO-VALLE DE LOS CHILLOS</option>
                                                ...
                                                <!---------------------------------------------------------PREGUNTA 3---------------------------------------------------->
                                                <div class="col-xs-12">
                                                    <input id="pregunta7" name="pregunta7" class="text-bold form-control" value="Horario de atención" readonly/>
                                                    <input type="text" id="respuesta7" name="respuesta7" class="text-bold form-control" readonly/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script src="scripts/JS_CCCACobranzas.js" type="text/javascript"></script>
